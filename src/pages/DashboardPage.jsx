...
export default function DashboardPage() {
 ...
 return (
 <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-200 max-w-6xl mx-auto">
 {/* Hero Header */}
 ...
 className="col-span-1 md:col-span-2 relative overflow-hidden group border-warning/20 bg-card/60 shadow-lg hover:shadow-warning/10 hover:border-warning/40 transition-all duration-150 cursor-pointer"
 >
 <div className="absolute top-1/2 -translate-y-1/2 right-4 p-6 opacity-5 group-hover:opacity-10 transition-all duration-200 group-hover:scale-110">
 ...
 <Card 
 onClick={() => setSearchParams({ modal: 'listings' })}
 className="col-span-1 md:col-span-2 relative overflow-hidden group border-primary/20 bg-card/60 shadow-lg hover:shadow-primary/10 hover:border-primary/40 transition-all duration-150 cursor-pointer"
 >
 <div className="absolute top-1/2 -translate-y-1/2 right-4 p-6 opacity-5 group-hover:opacity-10 transition-all duration-200 group-hover:scale-110">
 ...
 <Card className="col-span-1 bg-card/40 border-border/50 hover:border-chart-5/30 transition-all hover:shadow-lg flex flex-col justify-between overflow-hidden relative group">
 ...
 <div key={currentVehicleIndex} className="animate-in fade-in slide-in-from-right-4 duration-200">
 ...
 <div 
 key={idx} 
 className={`h-1.5 rounded-full transition-all duration-150 ${idx === currentVehicleIndex ? 'w-4 bg-chart-5' : 'w-1.5 bg-border'}`} 
 />
 ))}
 </div>
 )}
 ...
 <Card className="col-span-1 md:col-span-2 lg:col-span-3 bg-card/60 border-border/50 hover:shadow-lg transition-all mt-2">
