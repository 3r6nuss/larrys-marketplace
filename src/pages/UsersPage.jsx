...
export default function UsersPage() {
 ...
 <Card className="bg-card/40 border-primary/20 hover:border-primary/40 transition-all group">
 ...
 <Card className="bg-card/40 border-success/20 hover:border-success/40 transition-all group">
 <CardContent className="pt-5 pb-4 px-5 flex items-center justify-between">
 <div>
 ...
 <Card className="bg-card/40 border-destructive/20 hover:border-destructive/40 transition-all group">
 <CardContent className="pt-5 pb-4 px-5 flex items-center justify-between">
 <div>
