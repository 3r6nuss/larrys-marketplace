...
export default function CustomerHomePage() {
 ...
 title="Fahrzeug-Katalog" subtitle="Stöbere durch unser gesamtes Sortiment und finde dein Traumauto." value={publicStats?.total_available ?? 0} valueColor="text-primary"
